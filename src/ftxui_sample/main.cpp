...
// configuration step. It creates a namespace called `MySunnyLand`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", MySunnyLand::cmake::project_name, MySunnyLand::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", MySunnyLand::cmake::project_version);
      return EXIT_SUCCESS;
    }
